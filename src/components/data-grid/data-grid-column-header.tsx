  ...
  return (
    <>
      <DropdownMenu modal={false}>
        <DropdownMenuTrigger
          className={cn(
            "flex size-full items-center justify-between gap-2 px-3 py-2 text-sm text-zinc-700 hover:bg-zinc-100 data-[state=open]:bg-zinc-100 [&_svg]:size-4",
...
function DataGridColumnResizerImpl<TData, TValue>({
  ...
  return (
    <div
      ...
      tabIndex={0}
      className={cn(
        "absolute -end-px top-0 z-50 h-full w-0.5 cursor-ew-resize touch-none bg-border transition-opacity select-none after:absolute after:inset-y-0 after:inset-s-1/2 after:h-full after:w-4.5 after:-translate-x-1/2 after:content-[''] hover:bg-primary focus:bg-primary focus:outline-none",
