...
export function ShortTextCell<TData>({
  ...
  const placeholder = cell.column.columnDef.meta?.cell?.placeholder ?? ""
...
export function SelectCell<TData>({
  ...
  const displayLabel = optionByValue.get(value)?.label || (value ? value : "")
  return (
    <DataGridCellWrapper<TData>
      ref={containerRef}
      cell={cell}
        ...
        >
          ...
          >
            {displayLabel ? (
              ...
              >
                <SelectValue
                  placeholder={cell.column.columnDef.meta?.cell?.placeholder}
                />
              </Badge>
            ) : (
              <SelectValue
            ...
            <Command className="**:data-[slot=command-input-wrapper]:h-auto **:data-[slot=command-input-wrapper]:border-none **:data-[slot=command-input-wrapper]:p-0 [&_[data-slot=command-input-wrapper]_svg]:hidden">
              <div className="flex min-h-9 flex-wrap items-center gap-1 border-b px-3 py-1.5">
                ...
                <CommandInput
                  ...
                  placeholder={
                    cell.column.columnDef.meta?.cell?.placeholder ?? "Search..."
                  }
